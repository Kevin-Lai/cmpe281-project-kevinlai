 ...
 */
@DisplayName("Tests for WebAppController")
public class WebAppControllerTest {
    ...
    private WebAppController webAppController = new WebAppController(EXPECTED_SITE_NAME);
    ...
    void testHelloWorld() {
        ModelAndView actualModelAndView = webAppController.webAppLaunch();
